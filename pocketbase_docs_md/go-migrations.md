...
_For all supported record methods, you can refer to [Record operations](/docs/go-records)_ .
...
_For all supported collection methods, you can refer to [Collection operations](/docs/go-collections)_ .
